...
INSERT INTO `students` VALUES (1,'125.1245.147',1),(2,'125.1475.366',2),(3,'171.2056.014',3),(4,'161.2974.064',4),(5,'191.2007.007',5),(6,'181.2374.044',6),(7,'121.2987.621',7),(8,'161.2417.364',8),(9,'131.2607.071',9),(10,'171.2017.369',10),(11,'131.2607.071',11),(12,'103.4640.010',29),(13,'123.4562.789',30),(14,'101.2007.031',31);
...
INSERT INTO `students_courses` VALUES (1,5,1,1),(2,4,1,8),(3,7,3,8),(4,8,1,8),(5,6,1,13),(6,7,3,13),(7,8,2,13),(8,4,1,14),(9,9,3,14),(10,8,3,14);
...
INSERT INTO `students_process` VALUES (1,2,1),(2,2,2),(3,2,3),(4,2,4),(5,2,5),(6,2,6),(7,2,7),(8,3,8),(9,3,9),(10,3,10),(11,3,11),(12,11,12),(13,11,13),(14,11,14);
...
INSERT INTO `students_schools` VALUES (1,5,2),(2,6,1),(3,5,4),(4,7,5),(5,5,6),(6,6,7),(7,6,8),(8,7,9),(9,6,10),(10,7,11),(11,6,12),(12,6,13),(13,7,14);
...
BEGIN
    ...
    INSERT INTO students_process VALUES (null, (SELECT id FROM process WHERE denomination = getLastProcess()), @student_id);
...
-- Dump completed on 2021-03-19 19:40:42
