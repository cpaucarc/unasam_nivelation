                                    ...
                                    <div class="col col-6 col-lg-12">
                                        <div class="d-flex bd-highlight">
                                            <div class="form-group w-100">
                                                <label for="process" class="col-form-label col-form-label-sm"><i class="bi bi-calendar-check mr-2"></i>Proceso de
                                                    Admisión</label>
                        ...
                        <div class="alert alert-info my-3" role="alert">
                            <div class="row">
                                ...
                                <div class="col col-11 col-lg-10">
                                    ...
                                    <p>
                                        Muestra la cantidad de <strong>estudiantes</strong> general según el <strong>estado</strong>
                                        dirijase
