                            ...
                            <div class="card card-body bg-light">
                                <div class="row">
                                    ...
                                    <div class="col col-6 col-lg-12">
                                        <div class="d-flex bd-highlight">
                                            <div class="form-group w-100">
                                                <label for="tipeChart" class="col-form-label col-form-label-sm"><i
                                                            class="bi bi-bar-chart-line mr-2"></i>Tipo de
                                                    Gráfico</label>
                        ...
                        <div class="alert alert-info my-3" role="alert">
                            <div class="row">
                                ...
                                <div class="col col-11 col-lg-10">
                                    ...
                                    <small>
                                        Muestra la cantidad de <strong> <span class="badge-tipe"></span></strong> por
