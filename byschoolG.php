    ...
    <div class="row my-3">
            ...
            <div class="card">
                <div class="card-header text-center">
                    <div class="text-md font-weight-bold text-primary">
                        Proceso <span class="badge bg-primary text-light"><?php echo $_POST['scPDFCHART'] ?></span>
                        <input type="hidden" id="process" name="process" value="<?php echo $_POST['scPDFCHART']  ?>">
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="col col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
            <div class="card">
                <div class="card-header text-center">
                    <div class="text-md font-weight-bold text-primary">
                        Proceso <span class="badge bg-primary text-light">2020-I</span>
                    </div>
                </div>
                <div class="card-body">
...
<script src="public/js/graphics/byschoolG.js"></script>
