            ...
            <div class="card shadow-lg rounded-lg">
                <div class="card-body">
                    <div class="login-header mt-4">
                        ...
                        <h4 class="login-title ml-2">Sistema de Nivelación</h4>
                    </div>
                    <div class="form__content" id="form__content">
                        <form class="form-user col-12" id="form-user">
                            ...
                            <div class="form-group mb-4">
                                <input type="text" class="input-user" id="username" name="username"
...
<!--                            </div>-->
                        ...
                        <form class="form-password col-12" id="form-password">
                            ...
                            <div class="button-content">
                                <button class="btn btn-primary btn-user btn-block" type="submit" id="bnt-pws">
                                    Siguiente
                                </button>
                            </div>
                        </form>
