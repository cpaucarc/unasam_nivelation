        ...
        <div class="row">
            ...
            <div class="card mb-4 w-100">
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-lg-3">
                            <h6 class="text-dark text-uppercase font-weight-bold">Nombres:</h6>
                            <p class="text-uppercase small">Leonel Cristiano</p>
                        </div>
                        <div class="col-lg-3">
                            <h6 class="text-dark text-uppercase font-weight-bold">Apellidos:</h6>
                            <p class="text-uppercase small">Messi Ronaldo</p>
                        </div>
                        <div class="col-lg-2">
                            <h6 class="text-dark text-uppercase font-weight-bold">DNI:</h6>
                            <p class="text-uppercase small">72876524</p>
                        </div>
                        <div class="col-lg-4">
                            <h6 class="text-dark text-uppercase font-weight-bold">Escuela:</h6>
                            <p class="text-uppercase small">Ingeniería de sistemas e informática</p>
                        </div>
                    </div>
                </div>
            </div>
